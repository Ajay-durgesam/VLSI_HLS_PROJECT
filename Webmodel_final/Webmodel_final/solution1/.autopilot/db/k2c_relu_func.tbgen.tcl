...
set C_modelName {k2c_relu_func}
set C_modelType { void 0 }
set C_modelArgList {
	{ x float 32 regular {array 26000 { 1 0 } 1 1 }  }
	{ size int 64 regular  }
}
...
set portList { 
	...
	{ x_address1 sc_out sc_lv 15 signal 0 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.WebModel_fcmp_32nlbW_U46", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	x { ap_memory {  { x_address0 mem_address 1 15 }  { x_ce0 mem_ce 1 1 }  { x_q0 mem_dout 0 32 }  { x_address1 mem_address 1 15 }  { x_ce1 mem_ce 1 1 }  { x_we1 mem_we 1 1 }  { x_d1 mem_din 1 32 } } }
