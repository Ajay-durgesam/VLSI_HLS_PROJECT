...
#ifndef __WebModel_fcmp_32nlbW__HH__
#define __WebModel_fcmp_32nlbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WebModel_fcmp_32nlbW) {
    ...
    SC_CTOR(WebModel_fcmp_32nlbW):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
