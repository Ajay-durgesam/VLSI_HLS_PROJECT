...
#ifndef __WebModel_mac_mulaocq__HH__
#define __WebModel_mac_mulaocq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(WebModel_mac_mulaocq) {
    ...
    SC_CTOR(WebModel_mac_mulaocq):  simcore_mac_0_U ("simcore_mac_0_U") {
