...
#ifndef __WebModel_mul_mul_mb6__HH__
#define __WebModel_mul_mul_mb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WebModel_mul_mul_mb6) {
    ...
    SC_CTOR(WebModel_mul_mul_mb6):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
