...
entity WebModel_dense_70tde_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of WebModel_dense_70tde_rom is 
...
entity WebModel_dense_70tde is
    generic (
...
architecture arch of WebModel_dense_70tde is
    component WebModel_dense_70tde_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    WebModel_dense_70tde_rom_U :  component WebModel_dense_70tde_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
