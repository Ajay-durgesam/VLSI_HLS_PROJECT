...
if {[file isfile WebModel.autotvin.dat]} {
	file delete -force WebModel.autotvin.dat
}

if {[file isfile WebModel.autotvout.dat]} {
	file delete -force WebModel.autotvout.dat
}
