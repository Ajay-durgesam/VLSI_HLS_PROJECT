...
$(ObjDir)/WebModel_test_suite.c_pre.c.tb.o : WebModel_test_suite.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) WebModel_test_suite.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/WebModel.c_pre.c.tb.o : WebModel.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) WebModel.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
