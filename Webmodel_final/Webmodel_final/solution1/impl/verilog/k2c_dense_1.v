...
reg   [0:0] tmp_reg_351;
wire   [63:0] tmp_8_fu_246_p2;
reg   [63:0] tmp_8_reg_355;
wire   [0:0] icmp_fu_263_p2;
reg   [0:0] icmp_reg_360;
wire   [0:0] tmp_i_fu_269_p2;
wire    ap_CS_fsm_state3;
wire   [15:0] tmp_64_fu_274_p1;
reg   [15:0] tmp_64_reg_379;
...
wire  signed [63:0] outrows_fu_308_p3;
reg   [63:0] outrows_reg_418;
...
wire   [14:0] grp_k2c_relu_func_fu_227_x_address1;
wire    grp_k2c_relu_func_fu_227_x_ce1;
wire    grp_k2c_relu_func_fu_227_x_we1;
wire   [31:0] grp_k2c_relu_func_fu_227_x_d1;
...
wire   [62:0] tmp_63_fu_253_p4;
wire   [15:0] tmp_65_fu_289_p1;
wire   [15:0] tmp_i_51_fu_293_p2;
reg    grp_fu_315_ce;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1) & (tmp_fu_240_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1) & (tmp_fu_240_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state17) & (tmp_reg_351 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (tmp_fu_240_p2 == 1'd1))) begin
...
always @ (*) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state1) & (tmp_fu_240_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state13) | ((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1) & (tmp_fu_240_p2 == 1'd1)))) begin
...
always @ (*) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state12) | ((1'b1 == ap_CS_fsm_state17) & (tmp_reg_351 == 1'd1)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) | ((1'b1 == ap_CS_fsm_state17) & (tmp_reg_351 == 1'd1)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            ...
            end else if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1) & (tmp_fu_240_p2 == 1'd0))) begin
...
always @ (*) begin
    ap_block_state17_on_subcall_done = ((grp_k2c_relu_func_fu_227_ap_done == 1'b0) & (tmp_reg_351 == 1'd1));
end
...
assign icmp_fu_263_p2 = ((tmp_63_fu_253_p4 != 63'd0) ? 1'b1 : 1'b0);

assign j_fu_283_p2 = (ap_phi_mux_j_i_phi_fu_178_p4 + 64'd1);

assign output_array_address1 = grp_k2c_relu_func_fu_227_x_address1;

assign output_array_d1 = grp_k2c_relu_func_fu_227_x_d1;

assign outrows_fu_308_p3 = ((icmp_reg_360[0:0] === 1'b1) ? input_shape_q0 : 64'd1);

assign tmp_63_fu_253_p4 = {{input_ndim_read[63:1]}};

assign tmp_64_fu_274_p1 = i_i_reg_162[15:0];

assign tmp_65_fu_289_p1 = ap_phi_mux_j_i_phi_fu_178_p4[15:0];

assign tmp_8_fu_246_p2 = ($signed(input_ndim_read) + $signed(64'd18446744073709551615));

assign tmp_fu_240_p2 = ((input_ndim_read < 64'd3) ? 1'b1 : 1'b0);

assign tmp_i_51_fu_293_p2 = (tmp_65_fu_289_p1 + tmp_64_reg_379);

assign tmp_i_cast_fu_298_p1 = tmp_i_51_fu_293_p2;
