...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.WebModel.autotvin_dense_69_input_input_array.dat"
         "c.WebModel.autotvin_dense_69_input_input_ndim.dat"
         "c.WebModel.autotvin_dense_69_input_input_numel.dat"
         "c.WebModel.autotvin_dense_69_input_input_shape.dat"
         "c.WebModel.autotvin_dense_71_output_array.dat"
         "c.WebModel.autotvin_dense_71_output_numel.dat"
         "c.WebModel.autotvout_dense_71_output_array.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.WebModel.autotvout_dense_71_output_array.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
