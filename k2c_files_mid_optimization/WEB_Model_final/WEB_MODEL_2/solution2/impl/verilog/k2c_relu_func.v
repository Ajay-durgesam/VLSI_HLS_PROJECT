...
wire   [63:0] i_2_fu_65_p2;
reg   [63:0] i_2_reg_118;
wire    ap_CS_fsm_state2;
reg   [14:0] x_addr_reg_123;
...
wire   [0:0] tmp_3_fu_54_p2;
reg   [0:0] tmp_3_reg_138;
reg   [63:0] i_reg_42;
wire    ap_CS_fsm_state4;
wire   [0:0] tmp_4_fu_105_p2;
wire   [31:0] x_load_to_int_fu_71_p1;
wire   [7:0] tmp_fu_75_p4;
wire   [22:0] tmp_5_fu_85_p1;
...
WebModel_fcmp_32nncg #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 1 ))
WebModel_fcmp_32nncg_U49(
    .din0(x_q0),
    .din1(32'd0),
    .opcode(5'd5),
    .dout(tmp_3_fu_54_p2)
...
always @ (*) begin
    if (((tmp_4_fu_105_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        x_we0 = 1'b1;
    end else begin
        x_we0 = 1'b0;
    end
...
assign i_2_fu_65_p2 = (i_reg_42 + 64'd1);

assign notlhs_fu_89_p2 = ((tmp_fu_75_p4 != 8'd255) ? 1'b1 : 1'b0);

assign notrhs_fu_95_p2 = ((tmp_5_fu_85_p1 == 23'd0) ? 1'b1 : 1'b0);

assign tmp_2_fu_101_p2 = (notrhs_reg_133 | notlhs_reg_128);

assign tmp_4_fu_105_p2 = (tmp_3_reg_138 & tmp_2_fu_101_p2);

assign tmp_5_fu_85_p1 = x_load_to_int_fu_71_p1[22:0];
