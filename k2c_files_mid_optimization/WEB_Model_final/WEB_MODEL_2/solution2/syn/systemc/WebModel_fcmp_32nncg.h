...
#ifndef __WebModel_fcmp_32nncg__HH__
#define __WebModel_fcmp_32nncg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WebModel_fcmp_32nncg) {
    ...
    SC_CTOR(WebModel_fcmp_32nncg):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
