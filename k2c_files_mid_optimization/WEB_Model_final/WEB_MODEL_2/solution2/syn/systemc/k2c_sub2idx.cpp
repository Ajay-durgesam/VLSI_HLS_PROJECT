...
const sc_lv<7> k2c_sub2idx::ap_ST_fsm_state1 = "1";
const sc_lv<7> k2c_sub2idx::ap_ST_fsm_state2 = "10";
const sc_lv<7> k2c_sub2idx::ap_ST_fsm_state3 = "100";
const sc_lv<7> k2c_sub2idx::ap_ST_fsm_state4 = "1000";
const sc_lv<7> k2c_sub2idx::ap_ST_fsm_state5 = "10000";
const sc_lv<7> k2c_sub2idx::ap_ST_fsm_state6 = "100000";
const sc_lv<7> k2c_sub2idx::ap_ST_fsm_state7 = "1000000";
...
k2c_sub2idx::k2c_sub2idx(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    WebModel_mul_64s_bkb_U1->din0(shape_load_reg_188);
    WebModel_mul_64s_bkb_U1->din1(temp1_reg_71);
    WebModel_mul_64s_bkb_U1->ce(ap_var_for_const0);
    WebModel_mul_64s_bkb_U1->dout(grp_fu_132_p2);
    ...
    sc_trace(mVcdFile, i_cast1_reg_147, "i_cast1_reg_147");
...
void k2c_sub2idx::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        j_0_in_reg_81 = j_reg_170.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        j_0_in_reg_81 = ndim.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state7.read())) {
        temp1_reg_71 = grp_fu_132_p2.read();
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        temp1_reg_71 = sub_q0.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        i_1_reg_155 = i_1_fu_108_p2.read();
        i_cast1_reg_147 = i_cast1_fu_94_p1.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        j_reg_170 = j_fu_114_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        shape_load_reg_188 = shape_q0.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        tmp_1_reg_142 = tmp_1_fu_90_p1.read();
    }
}
...
void k2c_sub2idx::thread_exitcond_fu_103_p2() {
    exitcond_fu_103_p2 = (!i_cast_fu_99_p1.read().is_01() || !tmp_1_reg_142.read().is_01())? sc_lv<1>(): sc_lv<1>(i_cast_fu_99_p1.read() == tmp_1_reg_142.read());
}
...
void k2c_sub2idx::thread_tmp_fu_121_p2() {
    tmp_fu_121_p2 = (!j_fu_114_p2.read().is_01() || !i_cast1_reg_147.read().is_01())? sc_lv<1>(): (sc_biguint<64>(j_fu_114_p2.read()) > sc_biguint<64>(i_cast1_reg_147.read()));
}
