...
#ifndef __WebModel_mac_mulapcA__HH__
#define __WebModel_mac_mulapcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(WebModel_mac_mulapcA) {
    ...
    SC_CTOR(WebModel_mac_mulapcA):  simcore_mac_3_U ("simcore_mac_3_U") {
