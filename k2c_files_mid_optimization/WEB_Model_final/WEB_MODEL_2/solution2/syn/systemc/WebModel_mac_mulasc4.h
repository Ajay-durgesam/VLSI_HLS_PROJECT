...
#ifndef __WebModel_mac_mulasc4__HH__
#define __WebModel_mac_mulasc4__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(WebModel_mac_mulasc4) {
    ...
    SC_CTOR(WebModel_mac_mulasc4):  simcore_mac_5_U ("simcore_mac_5_U") {
