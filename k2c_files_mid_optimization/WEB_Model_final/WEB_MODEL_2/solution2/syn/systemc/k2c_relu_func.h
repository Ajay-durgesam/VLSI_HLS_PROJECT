...
#include "WebModel_fcmp_32nncg.h"
...
struct k2c_relu_func : public sc_module {
    ...
    WebModel_fcmp_32nncg<1,1,32,32,1>* WebModel_fcmp_32nncg_U49;
    sc_signal< sc_lv<4> > ap_CS_fsm;
    sc_signal< sc_logic > ap_CS_fsm_state1;
    sc_signal< sc_lv<64> > i_2_fu_65_p2;
    sc_signal< sc_lv<64> > i_2_reg_118;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<15> > x_addr_reg_123;
    sc_signal< sc_lv<1> > exitcond_fu_60_p2;
    sc_signal< sc_lv<1> > notlhs_fu_89_p2;
    sc_signal< sc_lv<1> > notlhs_reg_128;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_lv<1> > notrhs_fu_95_p2;
    sc_signal< sc_lv<1> > notrhs_reg_133;
    sc_signal< sc_lv<1> > tmp_3_fu_54_p2;
    sc_signal< sc_lv<1> > tmp_3_reg_138;
    sc_signal< sc_lv<64> > i_reg_42;
    sc_signal< sc_logic > ap_CS_fsm_state4;
    sc_signal< sc_lv<1> > tmp_4_fu_105_p2;
    sc_signal< sc_lv<32> > x_load_to_int_fu_71_p1;
    sc_signal< sc_lv<8> > tmp_fu_75_p4;
    sc_signal< sc_lv<23> > tmp_5_fu_85_p1;
