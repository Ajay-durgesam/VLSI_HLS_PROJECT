...
#ifndef __WebModel_mac_mulahbi__HH__
#define __WebModel_mac_mulahbi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(WebModel_mac_mulahbi) {
    ...
    SC_CTOR(WebModel_mac_mulahbi):  simcore_mac_1_U ("simcore_mac_1_U") {
