...
#ifndef __WebModel_mac_mularcU__HH__
#define __WebModel_mac_mularcU__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(WebModel_mac_mularcU) {
    ...
    SC_CTOR(WebModel_mac_mularcU):  simcore_mac_4_U ("simcore_mac_4_U") {
