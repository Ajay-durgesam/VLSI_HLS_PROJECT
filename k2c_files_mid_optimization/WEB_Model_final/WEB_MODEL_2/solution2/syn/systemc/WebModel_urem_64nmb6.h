...
#ifndef __WebModel_urem_64nmb6__HH__
#define __WebModel_urem_64nmb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WebModel_urem_64nmb6) {
    ...
    SC_CTOR(WebModel_urem_64nmb6):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
