...
#ifndef __WebModel_udiv_18nlbW__HH__
#define __WebModel_udiv_18nlbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WebModel_udiv_18nlbW) {
    ...
    ACMP_udiv_seq<ID, 22, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_udiv_seq_U;

    SC_CTOR(WebModel_udiv_18nlbW):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
