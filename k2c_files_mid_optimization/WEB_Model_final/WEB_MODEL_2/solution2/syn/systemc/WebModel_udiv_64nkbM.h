...
#ifndef __WebModel_udiv_64nkbM__HH__
#define __WebModel_udiv_64nkbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WebModel_udiv_64nkbM) {
    ...
    SC_CTOR(WebModel_udiv_64nkbM):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
