...
#ifndef __WebModel_mul_128nfYi__HH__
#define __WebModel_mul_128nfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(WebModel_mul_128nfYi) {
    ...
    SC_CTOR(WebModel_mul_128nfYi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
