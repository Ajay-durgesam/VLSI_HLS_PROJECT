...
set C_modelArgList {
	{ x float 32 regular {array 26000 { 2 3 } 1 1 }  }
	{ size int 64 regular  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.WebModel_fcmp_32nncg_U49", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	x { ap_memory {  { x_address0 mem_address 1 15 }  { x_ce0 mem_ce 1 1 }  { x_we0 mem_we 1 1 }  { x_d0 mem_din 1 32 }  { x_q0 mem_dout 0 32 } } }
